import{r as i,d as s}from"./read_write.afa2b7fa.js";async function l(){const o=await i();console.log(o),c(o)}l();function c(o){let f=o;const t=document.querySelector("#my_body");t.innerHTML="";for(let e=0;e<f.length;e++)t.innerHTML+=`
      <tr>
